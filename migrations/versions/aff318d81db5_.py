...
Revision ID: aff318d81db5
Revises: 
Create Date: 2022-04-07 22:58:58.710142
...
def upgrade():
    ...
    op.create_table('users_favorites_characters',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    op.create_table('users_favorites_planets',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('user_id', sa.Integer(), nullable=True),
    ...
    op.create_table('users_favorites_starships',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('user_id', sa.Integer(), nullable=True),
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('users_favorites_starships')
    op.drop_table('users_favorites_planets')
    op.drop_table('users_favorites_characters')
    op.drop_table('users')
